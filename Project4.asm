; Name: Wenzhuo Fan
; Date: 11/06/2020
; Description:  create a program that will determine if two strings are anagrams
; Resources: project4_template.asm
...
.code
    main proc
        ...
        VerifyLoop:
            mov bl, c1[ecx]         ;(7) move value of c1 into bl

            cmp bl, c2[ecx]         ;(8) check bl vs the value of c2
